...
public class ApplicationInfo  implements Serializable{
		...
		/**
		 * @param jdkVendor the jdkVendor to set
		 */
		...
		/**
		 * @param jdkVersion the jdkVersion to set
		 */
		...
		/**
		 * @param jdkHomePath the jdkHomePath to set
		 */
		...
		/**
		 * @param webContainerName the webContainerName to set
		 */
		...
		/**
		 * @param startWebContainerUser the startWebContainerUser to set
		 */
		...
		/**
		 * @param maxUseMemory the maxUseMemory to set
		 */
