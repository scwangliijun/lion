...
public interface RoleService{
	 ...
	 * @param role
	 * */
	public void doAuthUsersToRole(List<Long> targetUserIds,List<Long> deleteUserIds,Role role);
	/**
	 ...
	 * @param role
	 * */
	public void doAuthGroupsToRole(List<Long> targetGroupIds,List<Long> deleteGroupIds,Role role);
	 ...
	 * @param role
	 * */
	public void  doAuthResourceToRole(List<Long> targetResourceIds,List<Long> deleteResourceIds,Role role);
	/**根据用户ID查询用户角色集合
	 * @param userId
	 * @return List<Role>
	 * */
